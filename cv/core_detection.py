...
class ShopliftingDetector:
    ...
    def process_video(self, video_path, output_video_path, json_output_path, confidence_threshold=30, overlap_threshold=30):
        ...
        while cap.isOpened():
            ...
            # Checks if there's a suspicious or dangerous event
            ...
            if is_event:
                ...
                if self.active_event:
                    ...
                    # End the clip if it has been 2 seconds after the event occurred
        ...
        self.save_predictions_to_json(json_output_path)
    ...
    def classify_predictions(self, predictions):
        ...
        for obj in predictions:
            ...
            # Simple logic for determining if it's normal, suspicious, or dangerous
            if confidence > 0.6:
                level = 'normal'
    ...
    def draw_predictions_on_frame(self, frame, predictions):
        for obj in predictions:
            # Calculates the box's bounds/coordinates
    ...
    def save_predictions_to_json(self, json_output_path):
        with open(json_output_path, 'w') as json_file:
            json.dump(self.prediction_data, json_file, indent=4)
        print(f"Predictions exported to {json_output_path}.")